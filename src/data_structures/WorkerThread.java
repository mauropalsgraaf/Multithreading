...
public class WorkerThread<T extends Comparable<T>> extends Thread {
    ...
    private void doWork() {
        if (workTime > 0) {
            ...
            long start = bean.getCurrentThreadCpuTime(); //This line has been altered according to the mail of Ceriel

            // getThreadCpuTime() returns cpu time in nano seconds.
            long end = start + workTime * 1000;
            while (bean.getCurrentThreadCpuTime() < end) //This line has been altered according to the mail of Ceriel
